...
- **Nicholas Hathaway**. Author, maintainer.

## Citation

Source:
[`DESCRIPTION`](https://github.com/nickjhathaway/plasgenomicsutilsR/blob/v0.1.1/DESCRIPTION)

Hathaway N (2026). *plasgenomicsutilsR: Utilities for Visualizing
Plasmodium Genomics Data*. R package version 0.1.1,
